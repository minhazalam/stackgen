...
def create_spark_job(base_path: str) -> None:
    render_template(
        "spark/batch_job.py.j2",
        os.path.join(base_path, "spark/jobs/batch_job.py"),
        {},
    )
...
def create_airflow_dag(base_path: str, project_name: str) -> None:
    render_template(
        "airflow/dag.py.j2",
        os.path.join(base_path, "airflow/dags/pipeline_dag.py"),
        {"project_name": project_name},
    )
...
def create_kafka_producer(base_path: str) -> None:
    render_template(
        "kafka/producer.py.j2",
        os.path.join(base_path, "kafka/producer.py"),
        {},
    )
...
def create_spark_streaming_job(base_path: str) -> None:
    render_template(
        "spark/streaming_job.py.j2",
        os.path.join(base_path, "spark/jobs/streaming_job.py"),
        {},
    )